...
import { Alert, Pressable, ScrollView, StyleSheet, Switch, View, Modal, TextInput } from "react-native";
      ...
      {userData && (
        <ThemedView style={[styles.text, { paddingBottom: 15 }]}>
          ...
          <ThemedText style={{ color: activeColors.text}}>
            <ThemedText style={{ color: activeColors.text, fontWeight: "600" }}>Email: </ThemedText>{userData.email}
          </ThemedText>
        </ThemedView>
      )}
        ...
        {/* Sign Out (destructive) */}
          <View style={styles.accountButtonsRow}>
            ...
            >
              ...
              <ThemedText
                style={[styles.primaryText, { color: activeColors.primary, marginLeft: 8 }]}
              >
                Change Password
              </ThemedText>
            </Pressable>
        ...
        <BlurView intensity={50} tint="dark" style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: activeColors.background }]}>
            ...
            <TextInput
              ...
              style={[
                styles.input,
                { borderColor: activeColors.divider, color: activeColors.text },
              ]}
            />
            <TextInput
              value={newPassword}
            ...
            <View style={styles.modalButtons}>
              <Pressable
                ...
                style={[styles.button, { backgroundColor: activeColors.divider }]}
              >
